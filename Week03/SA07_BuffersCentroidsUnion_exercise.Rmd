...
manhattan <- raster("C:/Users/Lenovo/Desktop/Diverse dokumenter/Cognitive Science/cultural_data_science/cds-spatial/Week02/data/manhattan.tif")
...
* Project\transform the neighborhoods shapefile and use CRS number 32618 as the target CRS, this is the code for the CRS of the `manhattan` image.
...
neighborhoods <- read_sf("C:/Users/Lenovo/Desktop/Diverse dokumenter/Cognitive Science/cultural_data_science/cds-spatial/Week02/data/neighborhoods.shp")
...
beech <- read_sf(("C:/Users/Lenovo/Desktop/Diverse dokumenter/Cognitive Science/cultural_data_science/cds-spatial/Week02/data/beech.shp"))
...
beech_box <- st_bbox(beech, n = 1)
beech_box # only the extent

beech_box <- st_make_grid(beech, n = 1)
beech_box # makes a spatial object

# Plot the neighborhoods, add the beech trees and add the new box
plot(neighborhoods$geometry, col = "grey", border = "white")
plot(beech, add = TRUE, pch = 16, col = "forestgreen")
