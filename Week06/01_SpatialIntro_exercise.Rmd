...
quadrat.test(p2, alternative = "clustered") # Clustered

quadrat.test(p1, alternative = "regular") # Still not clustered
quadrat.test(p2, alternative = "regular") # Still not clustered
