...
# Here it becomes evident that the areas within the "high" have a greater probability than 0.15 to be violent, and that the "low" areas have a lower probability then 0.05? I think
```
