...
honeylocust_lim <- honeylocust %>% .[,c("tree_id", "boroname")]
...
parks$areas <- areas
big_parks <- parks[(unclass(areas) > 30000), ]

# Plot just the geometry of big_parks
plot(big_parks$geometry)
